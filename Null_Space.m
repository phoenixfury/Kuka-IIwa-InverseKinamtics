...
%NULL_SPACE Summary of this function goes here
%   Detailed explanation goes here
%% Joint ranges
qmin_range = [deg2rad(-170) deg2rad(-120) deg2rad(-170)  deg2rad(-120) deg2rad(-170) deg2rad(-120) deg2rad(-175)];
qmax_range = [deg2rad(170) deg2rad(120) deg2rad(170) deg2rad(120) deg2rad(170) deg2rad(120) deg2rad(175)];
